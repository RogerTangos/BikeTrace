...
@interface OldRideTableViewController : UITableViewController <UISearchDisplayDelegate, UISearchBarDelegate, UIAlertViewDelegate, UIGestureRecognizerDelegate>{
...
@property (nonatomic, retain) Ride * longPressRide;
